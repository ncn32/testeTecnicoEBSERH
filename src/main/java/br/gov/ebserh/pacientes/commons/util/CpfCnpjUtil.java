...
public class CpfCnpjUtil
{
	...
	public static boolean isCPF(int intCPF) {
        String strCPF =  String.valueOf(intCPF);
	...
	public static boolean isCNPJ(int intCNPJ) {
        String strCNPJ =  String.valueOf(intCNPJ);
        while (strCNPJ.length()<14)
        	strCNPJ = "0" + strCNPJ;
        return isCPF(strCNPJ);
	}
